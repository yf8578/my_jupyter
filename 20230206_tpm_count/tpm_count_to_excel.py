...
df = pd.DataFrame(index=file_countname, columns=['all_mapped_reads', 'lncRNA', 'lncRNA-ratio', 'miRNA', 'miRNA-ratio', 'other', 'other-ratio', 'protein_coding', 'protein_coding-ratio',
                  'pseudo', 'pseudo-ratio', 'rRNA', 'rRNA-ratio', 'scRNA', 'scRNA-ratio', 'snoRNA', 'snoRNA-ratio', 'snRNA', 'snRNA-ratio', 'tRNA', 'tRNA-ratio', 'misc_RNA', 'misc_RNA-ratio'])
...
df2 = pd.DataFrame(index=file_tpmname, columns=['lncRNA_TPM>0', 'lncRNA_TPM>1', 'lncRNA_TPM>5', 'lncRNA_TPM>10', 'miRNA_TPM>0', 'miRNA_TPM>1', 'miRNA_TPM>5', 'miRNA_TPM>10', 'other_TPM>0', 'other_TPM>1', 'other_TPM>5', 'other_TPM>10', 'protein_coding_TPM>0', 'protein_coding_TPM>1', 'protein_coding_TPM>5', 'protein_coding_TPM>10', 'pseudo_TPM>0', 'pseudo_TPM>1', 'pseudo_TPM>5', 'pseudo_TPM>10',
                   'rRNA_TPM>0', 'rRNA_TPM>1', 'rRNA_TPM>5', 'rRNA_TPM>10', 'scRNA_TPM>0', 'scRNA_TPM>1', 'scRNA_TPM>5', 'scRNA_TPM>10', 'snoRNA_TPM>0', 'snoRNA_TPM>1', 'snoRNA_TPM>5', 'snoRNA_TPM>10', 'snRNA_TPM>0', 'snRNA_TPM>1', 'snRNA_TPM>5', 'snRNA_TPM>10', 'tRNA_TPM>0', 'tRNA_TPM>1', 'tRNA_TPM>5', 'tRNA_TPM>10', 'misc_RNA_TPM>0', 'misc_RNA_TPM>1', 'misc_RNA_TPM>5', 'misc_RNA_TPM>10'])
# 读取tpm文件夹中的文件
